...
app.factory('blogsService', ['$q', '$http', function ($q, $http) {
        return {
            ...
            deleteBlog: function (reqData) {
                var deferred = $q.defer();
                /* Make HTTP request for user profile data */ //{UserGUID: UserGUID}
                $http.post(base_url + 'admin_api/blogs/deleteblog', reqData).success(function (data) {
                    deferred.resolve(data);
                }).error(function (data) {
                    deferred.reject(data);
                });
            ...
            getDeleteList: function (reqData) {
                var deferred = $q.defer();
                /* Make HTTP request for user profile data */ //{UserGUID: UserGUID}
                $http.post(base_url + 'admin_api/blogs/list', reqData).success(function (data) {
                    deferred.resolve(data);
                }).error(function (data) {
                    deferred.reject(data);
                });
